...
<body>
    <nav class="shadow py-4 fixed top-0 bg-white w-full z-50">
        <div id="navbar" class="relative flex items-center justify-between container px-5 mx-auto">
            ...
            <div id="auth-menu" class="flex items-center gap-1">
                <button class="bg-primary text-white font-semibold px-6 py-2 rounded-full">Sign in</button>
        ...
        <header class="w-full h-[500px] mt-4 bg-cover bg-bottom rounded-xl px-20 relative"
            ...
            <div
                ...
                <div class="flex justify-between mt-4 items-center">
                    ...
                    <div class="">
                        <button
                            class="bg-primary py-2 font-bold text-white rounded-full w-48 flex items-center gap-3 px-4 ">
    ...
    <footer>
        <div class="bg-primary w-full p-10 relative overflow-hidden h-[170px]">
