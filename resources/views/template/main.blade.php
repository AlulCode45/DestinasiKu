...
<body x-data="{ page: 'ecommerce', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, showPrivacyPolicy: false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
