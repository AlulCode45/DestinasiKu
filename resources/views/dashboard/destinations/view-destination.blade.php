        ...
        <div class="flex gap-5">
            <div class="image w-1/2 relative">
                <div class="relative" id="upload-image">
                    ...
                    <div
                        class="absolute z-50 bg-black/50 hidden w-full h-full top-0 rounded place-content-center transition-all duration-1000 ease-in-out"
                        ...
                        <svg fill="#fff" width="100px" height="100px" viewBox="0 0 24 24" id="upload"
                            ...
                            <line id="primary" x1="12" y1="16" x2="12" y2="3"
                                  style="fill: none; stroke: rgb(255, 255, 255); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></line>
